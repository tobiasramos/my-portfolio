    ...
    <div className={styles.aboutMe}>
      ...
      <div className={styles.container}>
        <p className={styles.summary}>
          ...
          novas para mim, experiências como essas expandiu meus conhecimentos e
          habilidades. Além desse meu lado profissional, sou também um grande
          praticante de esportes. Tenho um imenso apego ao muay thai, e ao
          ciclismo, em ambos esportes já participei de competições e assim é a
          minha rotina, estuando, trabalhando e praticando esses esportes.
        </p>
      </div>
    </div>
  );
